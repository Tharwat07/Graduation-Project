...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(4,146,254, 1);
  static Color accent_color_shadow = Color.fromRGBO(229,65,28, .40);
  static Color accent_shadow = Color(0xFFFEEAE1);
  static Color accent = Color.fromRGBO(4,146,254, 1); // this color is a dropshadow of
// this color is a dropshadow of
// this color is a dropshadow of
  static Color soft_accent_color = Color.fromRGBO(254,234,209, 1);
  static Color splash_screen_color = Color.fromRGBO(4,146,254, 1); // if not sure , use the same color as accent color
