...
import 'package:union/screens/select_address.dart';
            ...
            Row(
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    height: 50,
                    width: (MediaQuery.of(context).size.width - 48) * (2 / 3.1),
                    decoration: BoxDecoration(
                        color: Colors.white,
                        // border:
                        //     Border.all(color: MyTheme.accent_color, width: 1),
                    ...
                    child: MaterialButton(
                      ...
                      minWidth: MediaQuery.of(context).size.width,
                      color: MyTheme.accent_color,
                      onPressed: () {onPressProceedToShipping();},
                      child: Text(
                          AppLocalizations.of(context).cart_screen_proceed_to_shipping,
                        style: TextStyle(
                            color: MyTheme.white, fontSize: 15,fontWeight: FontWeight.bold),
                      ),
                    ),
