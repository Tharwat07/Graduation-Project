...
import 'package:union/helpers/string_helper.dart';
...
class BundleProducts extends StatefulWidget {
  ...
  @override
  _BundleProductsState createState() => _BundleProductsState();
}
...
class _BundleProductsState extends State<BundleProducts> {
  ...
  void initState() {
    ...
    _future =
        ProductRepository().getBundleProducts(id: widget.bundle_id);
    _searchList = [];
    _fullList = [];
    super.initState();
  }
  ...
  Container buildBundlesBanner(BuildContext context) {
    return Container(
      //color: MyTheme.amber,
      height: 215,
  ...
  Widget buildBundleBannerShimmer() {
